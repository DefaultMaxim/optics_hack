...
def calc_loss(path2model):
    ...
    def funct_loss_enclosed_energy(enclosed_energy,
                                   perc_max_enclosed_energy_for_loss,
    ...
    #     f'{loss_FD=},  '
    #     f'{loss_total_length=},  '
    #     f'{loss_min_thickness=},  '
    #     f'{loss_min_thickness_air=},  '
    #     f'{loss_enclosed_energy_all=},  '
    #     f'{loss_rms_all=}')

    # layout_plt0 = plt.figure(FigureClass=InteractiveLayout,
    #                          opt_model=opm,
    #                          do_draw_rays=True,
